...
DROP FUNCTION IF EXISTS resource_assign_owner_role_on_creation();
...
DROP FUNCTION IF EXISTS prevent_folders_circular_dependency();
DROP FUNCTION IF EXISTS mkdir();
DROP FUNCTION IF EXISTS chmod();
